...
public enum CustomArmorMaterial implements ArmorMaterial {
    ...
    private static final int[] BASE_DURABILITY = {13, 16, 14, 12};

    CustomArmorMaterial(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound,
    ...
    public String getName() {
        return TheBebra.MOD_ID + ":" + this.name;
    }
